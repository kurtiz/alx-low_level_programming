...
## 3. The numbers speak for `mandatory` 
...
### 4. I believe in numbers and `mandatory` 
...
## 5. Numbers constitute the only universal `mandatory` 
...
## 6. The shortest distance between two points is a straight `mandatory` 
...
## 7. I feel like I am diagonally parked in a parallel `mandatory` 
...
## 8. You are so much sunshine in every square `mandatory` 
